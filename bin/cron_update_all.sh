...
${path_cake_cmd} snapshot.snapshot take_snapshot
${path_cake_cmd} snapshot.snapshot new_entities
${path_cake_cmd} snapshot.snapshot update_entities
${path_cake_cmd} snapshot.snapshot update_stats
